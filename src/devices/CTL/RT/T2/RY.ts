...
export abstract class CTL_RT_T2_RY extends SdcSoftDevice {
    ...
    public getBeng(): AElement[] {
        ...
        if (map.containsKey(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG)) {
            let deviceFieldForUI = map.getItem(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG);
            ...
            if (map2.containsKey(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG_1)) {
                d1 = map2.getItem(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG_1);
                count = 1;
            }
            if (map2.containsKey(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG_2)) {
                d2 = map2.getItem(CTL_RT_T2_RY.KEY_POINT_Add_SHUI_BENG_2);
                count += 2;
            }
            let v1 = 0, v2 = 0;
            switch (count) {
        ...
        if (map.containsKey(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG)) {
            let deviceFieldForUI = map.getItem(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG);
            let element = new AElement();
            element.setTitle(deviceFieldForUI.getTitle());
            element.setPrefix(AElement.Prefix_Beng);
            ...
            let count = 0;
            if (map2.containsKey(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG_1)) {
                d1 = map2.getItem(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG_1);
                count = 1;
            }
            if (map2.containsKey(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG_2)) {
                d2 = map2.getItem(CTL_RT_T2_RY.KEY_POINT_LENG_NING_BENG_2);
                count += 2;
            }
            let v1 = 0, v2 = 0;
            switch (count) {
