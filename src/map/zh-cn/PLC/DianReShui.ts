...
export = class Map_PLC_DianReShui extends PLC_Map {
    ...
    constructor() {
        ...
        this.addPoint(new SettingField('se_shiyongjiarezushusheding', 131, 4, '使用加热组数设定', '组', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0040', 1, 100))
        this.addPoint(new SettingField('se_touqiejiangeshijiansheding', 135, 4, '投切间隔时间设定', 'S', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0042', 1, 180))
        this.addPoint(new SettingField('se_kuaiqiejiangeshijiansheding', 139, 4, '快切间隔时间设定', 'S', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0044', 10, 600))
        this.addPoint(new SettingField('se_tingluwendusheding', 143, 4, '停炉温度设定', '℃', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0046', 0, 400))
        this.addPoint(new SettingField('se_shiyongwendusheding', 147, 4, '使用温度设定', '℃', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0048', 0, 400))
        this.addPoint(new SettingField('se_qiluwendusheding', 151, 4, '启炉温度设定', '℃', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '004A', 0, 400))
        this.addPoint(new SettingField('se_yalidibaojingsheding', 155, 4, '压力低报警设定', 'Mpa', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '004C', 0, 2.5))
        this.addPoint(new SettingField('se_yaligaobaojingsheding', 159, 4, '压力高报警设定', 'Mpa', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '004E', 0, 2.5))
        this.addPoint(new SettingField('se_qibengyalisheding', 163, 4, '启泵压力设定', 'Mpa', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0050', 0, 2.5))
        this.addPoint(new SettingField('se_tingbengyalisheding', 167, 4, '停泵压力设定', 'Mpa', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0052', 0, 2.5))
        this.addPoint(new SettingField('se_xunhuanbengshangxianwendusheding', 171, 4, '循环泵上限温度设定', '℃', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0054', 0, 400))
        this.addPoint(new SettingField('se_xunhuanbengxiaxianwendusheding', 175, 4, '循环泵下限温度设定', '℃', 0, Map_PLC_DianReShui.Commands_Key_Parameters_Setting, '0056', 0, 400))
        ...
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（电极）', 8))
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_ChaoYa, 233, 2, '系统超压报警（设定值）', 9),
            'ex_xitongchaoyabaojing（shedingzhi')
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_DiYa, 233, 2, '系统压力低报警（设定值）', 10),
            'ex_xitongyalidibaojing（shedingzhi）')
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_ChaoYa, 233, 2, '系统超压报警（电接点压力表）', 11),
            'ex_xitongchaoyabaojing（dianjiedianyalibiao）')
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_DiYa, 233, 2, '系统压力低报警（电接点压力表）', 12),
            'ex_xitongyalidibaojing（dianjiedianyalibiao）')
        ...
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_LuBiChaoWen, 233, 2, '炉壁超温报警', 1))
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_WaiBuLianSuoDuanKai, 233, 2, '外部连锁断开报警', 2))
