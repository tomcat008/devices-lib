...
export = class Map_PLC_RanYouReShui extends PLC_Map {
    constructor() {
        ...
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_POWER, '燃料', 0, Map_PLC_RanYouReShui.coms_power))
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_MEDIA, '介质', 0, Map_PLC_RanYouReShui.coms_media))
        this.addPoint(new BaseInfoField('ba_shuiweizhuangtai', 19, 2, '水位状态', '', Map_PLC_RanYouReShui.coms_level))
        this.addPoint(new BaseInfoField('ba_ranshaoqizhuangtai', 21, 2, '燃烧器状态', '', PLC_Map.coms_ranshaoqi_status))



        this.addPoint(new MockField(FixFieldNames.KEY_MOCK_ChuKouWenDu, 35, 4, '出水温度', '℃'))
        this.addPoint(new MockField(FixFieldNames.KEY_MOCK_HuiLiuWenDu, 39, 4, '回水温度', '℃'))
        this.addPoint(new MockField(FixFieldNames.KEY_MOCK_PaiYanWenDu, 43, 4, '排烟温度', '℃'))
        ...
        this.addPoint(new SettingField('se_qiluwendusheding', 248, 4, '启炉温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0078', 0, 400))
        this.addPoint(new SettingField('se_mubiaowendusheding', 252, 4, '目标温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007A', 0, 400))
        this.addPoint(new SettingField('se_tingluwendusheding', 256, 4, '停炉温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007C', 0, 400))
        this.addPoint(new SettingField('se_yalidisheding', 260, 4, '压力低设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007E', 0, 2.5))
        this.addPoint(new SettingField('se_yaligaosheding', 264, 4, '压力高设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0080', 0, 2.5))
        this.addPoint(new SettingField('se_paiyanwenduchaogaobaojingsheding', 268, 4, '排烟温度超高报警设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0082', 0, 400))
        this.addPoint(new SettingField('se_chukouwenduchaogaobaojingsheding', 272, 4, '出口温度超高报警设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0084', 0, 400))
        this.addPoint(new SettingField('se_yalichaogaobaojingsheding', 276, 4, '压力超高报警设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0086', 0, 2.5))
        this.addPoint(new SettingField('se_yalichaodibaojingsheding', 280, 4, '压力超低报警设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0088', 0, 2.5))
        ...
        this.addPoint(new DeviceField(PLC.KEY_POINT_Add_SHUI_BENG_1, 372, 2, '1#补水泵', Map_PLC_RanYouReShui.coms_start_stop))
        this.addPoint(new DeviceField('de_2_addshuibeng_auto', 374, 2, '2#补水泵', PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_Add_SHUI_BENG_2, 376, 2, '2#补水泵', Map_PLC_RanYouReShui.coms_start_stop))
        this.addPoint(new DeviceField('de_1_xunhuanbeng_auto', 378, 2, '1#循环泵', PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_1, 380, 2, '1#循环泵', Map_PLC_RanYouReShui.coms_start_stop))
        this.addPoint(new DeviceField('de_2_xunhuanbeng_auto', 382, 2, '2#循环泵', PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_2, 384, 2, '2#循环泵', Map_PLC_RanYouReShui.coms_start_stop))


        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_LuBiChaoWen, 448, 2, '炉壁超温报警', 0))
        ...
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_WaiBuLianSuoDuanKai, 448, 2, '外部连锁断开报警', 6))
        ...
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_ChaoYa, 448, 2, '压力超高报警', 11))
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_DiYa, 448, 2, '压力超低报警', 12))
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_PaiYanWenDuChaoGao, 448, 2, '排烟温度超高报警', 13))
        this.addPoint(new ExceptionField(FixFieldNames.KEY_Expt_ChuKouWenDuChaoGao, 448, 2, '出水温度超高报警', 14))
