...
export abstract class Map_CTL_RT extends Map_EN_US {
    ...
    constructor(){
        ...
        this.addPoint(new CountShowField(Map_CTL_RT.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_DAYS, "Running Days", "Day"));
        this.addPoint(new CountShowField(Map_CTL_RT.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_HOURS, "Running Hours", "Hour"));
