...
export = class Map_PLC_RanYouReShui extends PLC_Map {
    constructor(){
        ...
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_MEDIA, '介质', 0, Map_ZH_CN.coms_media))
        ...
        this.addPoint(new DeviceField(PLC.KEY_POINT_Add_SHUI_BENG_1, 372, 2, '1#补水泵', Map_ZH_CN.coms_start_stop))
        this.addPoint(new DeviceField('de_2_addshuibeng_auto', 374, 2, '2#补水泵',PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_Add_SHUI_BENG_2, 376, 2, '2#补水泵', Map_ZH_CN.coms_start_stop))
        this.addPoint(new DeviceField('de_1_xunhuanbeng_auto', 378, 2, '1#循环泵',PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_1, 380, 2, '1#循环泵', Map_ZH_CN.coms_start_stop))
        this.addPoint(new DeviceField('de_2_xunhuanbeng_auto', 382, 2, '2#循环泵',PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_2, 384, 2, '2#循环泵', Map_ZH_CN.coms_start_stop))
