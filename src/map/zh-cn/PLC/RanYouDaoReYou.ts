...
export = class Map_PLC_RanYouDaoReYou extends PLC_Map {
    constructor() {
        ...
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_POWER, '燃料', 0, Map_PLC_RanYouDaoReYou.coms_power))
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_MEDIA, '介质', 2, Map_PLC_RanYouDaoReYou.coms_media))
        this.addPoint(new BaseInfoField('ba_shuiweizhuangtai', 19, 2, '水位状态', '', Map_PLC_RanYouDaoReYou.coms_level))
        ...
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_2, 209, 2, '2#循环泵', Map_PLC_RanYouDaoReYou.coms_start_stop))
        this.addPoint(new DeviceField('de_3_xunhuanbeng_auto', 211, 2, '3#循环泵', PLC_Map.coms_atuo))
        this.addPoint(new DeviceField(PLC.KEY_POINT_XUN_HUAN_BENG_3, 213, 2, '3#循环泵', Map_PLC_RanYouDaoReYou.coms_start_stop))
