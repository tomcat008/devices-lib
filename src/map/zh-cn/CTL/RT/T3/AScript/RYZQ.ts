...
export class Map_CTL_RT_T3_RYZQ_Ts extends Map_CTL_RT_T3_Ts {
    constructor() {
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "冷凝循环泵控制",5,Map_ZH_CN.coms_open_close))
        this.addPoint(new OpenCloseField("oc_baojingzhuangtaishuchu", 9, 2, "报警状态输出",8,Map_ZH_CN.coms_open_close))
