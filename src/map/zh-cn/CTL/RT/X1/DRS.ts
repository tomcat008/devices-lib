...
export = class CTL_RT_X1_DRS extends CTL_RT_X1_Ts {
    constructor(){
        super();
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态",'',CTL_RT_X1_DRS.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间","时"));
        this.addPoint(new CountShowField(CTL_RT_X1_DRS.KEY_BASE, SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(CTL_RT_X1_DRS.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"))
        this.addPoint(new CountShowField(CTL_RT_X1_DRS.KEY_BASE, 'ba_shuiweioryalizhuangtai', "水位(压力)状态", ''));
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_POWER, "燃料类型", 1, ZH_CN.coms_power));
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_MEDIA, "介质类型", 0, ZH_CN.coms_media));


        this.addPoint(new DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "热水泵",3, CTL_RT_X1_DRS.coms_auto));
        ...
        this.addPoint(new OpenCloseField("oc_jiarezu1kongzhi", 9, 2, "加热组1控制",0,ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_jiarezu2kongzhi", 9, 2, "加热组2控制",1,ZH_CN.coms_open_close));
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "热水泵控制",2,ZH_CN.coms_open_close));
