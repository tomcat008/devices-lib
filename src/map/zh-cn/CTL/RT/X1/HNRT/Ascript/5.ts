...
export class Map_CTL_RT_X1_HNRT_RYZQ_5 extends Map_CTL_RT_X1_ZhengQi {
    ...
    constructor() {
        ...
        this.addPoint(new CountShowField(GroupKeys.KEY_BASE, 'ba_yalizhuangtai', '压力状态', '', false, Map_CTL_RT_X1_HNRT_RYZQ_5.DJD_YaLiStatus))
        ...
        this.addPoint(new MockField(FixFieldNames.KEY_MOCK_PaiYanWenDu, 13, 2, '排烟温度', '℃'))
