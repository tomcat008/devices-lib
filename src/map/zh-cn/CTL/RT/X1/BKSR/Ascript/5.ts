...
export class Map_CTL_RT_X1_BKSR_RMRS_5 extends Map_CTL_RT_X1_3JDJD {
    constructor() {
        ...
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_POWER, "燃料类型", 2, Map_CTL_RT_X1_BKSR_RMRS_5.coms_power))

        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "热水泵", 2, Map_CTL_RT_X1_BKSR_RMRS_5.coms_open_close))
        this.addPoint(new DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "热水泵 手/自", 3, Map_CTL_RT_X1_BKSR_RMRS_5.coms_auto))

        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_YIN_FENG_FAN_1, 9, 2, "引风机", 0, Map_CTL_RT_X1_BKSR_RMRS_5.coms_open_close))
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_GU_FENG_FAN_1, 9, 2, "鼓风机", 1, Map_CTL_RT_X1_BKSR_RMRS_5.coms_open_close))
