...
export class Map_CTL_RT_X1_HNRT_DZQ_7 extends Map_CTL_RT_X1_ZhengQi {
    constructor() {
        ...
        this.addPoint(new CountShowField(GroupKeys.KEY_BASE, 'ba_yalizhuangtai', '压力状态', '', false, Map_CTL_RT_X1_HNRT_DZQ_7.DJD_YaLiStatus))
        this.addPoint(new DeviceField('oc_jiarezu1kongzhi', 9, 2, '加热组1', 0, Map_CTL_RT_X1_HNRT_DZQ_7.coms_open_close))
        this.addPoint(new DeviceField('oc_jiarezu2kongzhi', 9, 2, '加热组2', 1, Map_CTL_RT_X1_HNRT_DZQ_7.coms_open_close))
        ...
        this.addPoint(new OpenCloseField('oc_chaoyabaojing', 5, 2, '超压报警', 6, Map_CTL_RT_X1_HNRT_DZQ_7.coms_open_close))
