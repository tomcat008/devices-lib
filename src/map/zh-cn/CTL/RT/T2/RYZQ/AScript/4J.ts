...
export class Map_CTL_RT_T2_RYZQ_4J extends Map_CTL_RT_T2_RYZQ_Ts {
    ...
    constructor() {
        ...
        this.addPoint(new OpenCloseField("oc_dishuiweidianji", 5, 2, "低水位电极", 2, Map_CTL_RT_T2_RYZQ_4J.coms_open_close))
        ...
        this.addPoint(new OpenCloseField("oc_gaoshuiweidianji", 5, 2, "高水位电极", 4, Map_CTL_RT_T2_RYZQ_4J.coms_open_close))
        this.addPoint(new OpenCloseField("oc_gaoshuiweibaojingdianji", 5, 2, "高水位报警电极", 5, Map_CTL_RT_T2_RYZQ_4J.coms_open_close))


        this.addPoint(new OpenCloseField("oc_queshuidianji2", 5, 2, "缺水电极2", 7, Map_CTL_RT_T2_RYZQ_4J.coms_open_close))
