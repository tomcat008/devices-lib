...
export = class CTL_HNWR_485 extends ParentClass {
    ...
    constructor() {
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 9, 2, "工作状态", '', CTL_HNWR_485.coms_status));

        this.addPoint(new BaseInfoField("mo_cuowuyuan", 7, 2, "错误源", '', CTL_HNWR_485.coms_error));

        this.addPoint(new OpenCloseField("oc_CHmoshi1", 3, 1, "CH模式", 0, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_DHWmoshi1", 3, 1, "DHW模式", 1, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_ceshimoshi1", 3, 1, "测试模式", 2, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_huoyan1", 3, 1, "火焰", 3, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_cuowu", 4, 1, "错误", 0, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_fa1", 4, 1, "阀1", 1, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_fa2", 4, 1, "阀2", 2, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_APS", 4, 1, "APS", 3, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_fengji", 4, 1, "风机", 4, ZH_CN.coms_open_close));
        ...
        this.addPoint(new DeviceField("de_yanwenchuanganqi", 35, 2, "烟温传感器", ZH_CN.coms_open_close));
        ...
        this.addPoint(new OpenCloseField("oc_ceshimoshi", 12, 1, "测试模式", 0, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_CHmoshi", 12, 1, "CH模式", 2, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_fangdongmoshi", 12, 1, "防冻模式", 3, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_huoyan", 12, 1, "火焰", 4, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_CHbeng", 12, 1, "CH泵", 5, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_jilianbeng", 12, 1, "级联泵", 7, ZH_CN.coms_open_close));
