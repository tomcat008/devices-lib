...
export class Map_CTL_RT_X1_HNRT_RYRS_2 extends Map_CTL_RT_X1_3JDJD {
    constructor() {
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_RAN_SHAO_QI_KONGZHI, 9, 2, '燃烧器', 0, Map_CTL_RT_X1_HNRT_RYRS_2.coms_open_close))
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, '多功能泵', 2, Map_CTL_RT_X1_HNRT_RYRS_2.coms_open_close))
        ...
        this.addPoint(new OpenCloseField('oc_ranshaoqiguzhang', 5, 2, '燃烧器故障', 7, Map_CTL_RT_X1_HNRT_RYRS_2.coms_open_close))

        this.addPoint(new OpenCloseField('oc_ranshaoqifuhetiaojie', 9, 2, '燃烧器负荷调节', 1, Map_CTL_RT_X1_HNRT_RYRS_2.coms_open_close))
    }
}