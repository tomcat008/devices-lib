...
export = class Map_CTL_RT_X1_5 extends Map_CTL_RT_X1_Ts {
    ...
    constructor() {
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态",'',Map_CTL_RT_X1_5.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间","时"));
        this.addPoint(new CountShowField(Map_CTL_RT_X1_5.KEY_BASE, SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(Map_CTL_RT_X1_5.KEY_BASE, SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        this.addPoint(new CountShowField(Map_CTL_RT_X1_5.KEY_BASE, 'ba_yalizhuangtai', "压力状态", ''));
        ...
        this.addPoint(new DeviceField("de_bushuibeng_shoudong/zidong_", 49, 2, "给水泵",1, Map_CTL_RT_X1_5.coms_auto));
