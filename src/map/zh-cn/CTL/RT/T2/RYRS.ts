...
export = class Map_CTL_RT_T2_RYRS extends Map_CTL_RT_T2_Ts {
    ...
    constructor() {
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "工作状态", '', Map_CTL_RT_T2_RYRS.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "累计燃烧时间", "时"));
        this.addPoint(new CountShowField(Map_CTL_RT_T2_RYRS.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(Map_CTL_RT_T2_RYRS.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        ...
        this.addPoint(new OpenCloseField("oc_chaoyabaojingxinhao", 5, 2, "超压报警", 9, Map_ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_ranshaoqiguzhangxinhao", 5, 2, "燃烧器故障信号", 10, Map_ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_ranqiyalidibaojingxinhao", 5, 2, "燃气压力低报警信号", 12, Map_ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_ranqixieloubaojingxinhao", 5, 2, "燃气泄漏报警信号", 11, Map_ZH_CN.coms_open_close));

        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_RAN_SHAO_QI_KONGZHI, 9, 2, "燃烧器启停控制", 0, Map_ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_ranshaoqifuhediaojie/zengdadiaojie", 9, 2, "燃烧器负荷增大调节", 1, Map_ZH_CN.coms_open_close));
        ...
        this.addPoint(new DeviceField("de_bushuibengzhubei", 49, 2, "补水泵", 0, Map_CTL_RT_T2_RYRS.coms_master));
        this.addPoint(new DeviceField("de_bushuibengshoudongzidong", 49, 2, "补水泵", 1, Map_CTL_RT_T2_RYRS.coms_auto));
        this.addPoint(new DeviceField("de_xunhuanbengzhubei", 49, 2, "循环泵", 2, Map_CTL_RT_T2_RYRS.coms_master));
        this.addPoint(new DeviceField("de_xunhuanbengshoudongzidong", 49, 2, "循环泵", 3, Map_CTL_RT_T2_RYRS.coms_auto));
        ...
        this.addPoint(new BaseInfoField("o_guoluleixing", 87, 2, "锅炉类型", '', Map_CTL_RT_T2_RYRS.coms_guolu));
        this.addPoint(new BaseInfoField("o_ranshaoqigongzuofangshi", 89, 2, "燃烧器工作方式", '', Map_CTL_RT_T2_RYRS.coms_ranshaoqi));
        this.addPoint(new BaseInfoField("o_bushuibengkongzhifangshi", 91, 2, "补水泵控制方式", '', Map_CTL_RT_T2_RYRS.coms_bushuibeng));
        this.addPoint(new BaseInfoField("o_xunhuanbengkongzhifangshi", 93, 2, "循环泵控制方式", '', Map_CTL_RT_T2_RYRS.coms_xunhuanbeng));
