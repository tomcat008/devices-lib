...
export = class CTL_RT_X1_RYKS extends CTL_RT_X1_Ts {
    constructor(){
        super();
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态",'',CTL_RT_X1_RYKS.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间","时"));
        this.addPoint(new CountShowField(CTL_RT_X1_RYKS.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(CTL_RT_X1_RYKS.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        ...
        this.addPoint(new DeviceField("de_bushuibeng_shoudong/zidong_", 49, 2, "补水泵",1, CTL_RT_X1_RYKS.coms_auto));
        this.addPoint(new DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "出水泵",3,CTL_RT_X1_RYKS.coms_auto));
        ...
        this.addPoint(new OpenCloseField("oc_didianji/dianjiedianyalibiaodizhen", 5, 2, "低位电极",1,ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_gaodianji/dianjiedianyalibiaogaozhen", 5, 2, "高位电极",2,ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField( "oc_lubiwendukaiguan", 5, 2, "炉壁温度开关",4,ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_shuixiangdiweidianji", 5, 2, "水箱低位电极",5,ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_shuixianggaoweidianji", 5, 2, "水箱高位电极",6,ZH_CN.coms_open_close));
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_Add_SHUI_BENG_1, 9, 2, "补水泵控制",1,ZH_CN.coms_open_close));
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "出水泵控制",2,ZH_CN.coms_open_close));
