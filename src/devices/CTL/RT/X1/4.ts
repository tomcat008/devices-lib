...
export =class Map_CTL_RT_X1_4 extends CTL_RT {
    constructor() {
        super();
    ...
    protected addFocusFields(list: List<DeviceFieldForUI>) {
        ...
        field.setValueString(Map_CTL_RT_X1_Ts.coms_lv_yl_sw_status[n1 + n2 + n3]);


        field = map.getItem(Map_CTL_RT_X1_4.KEY_POINT_RAN_SHAO_QI);
        let count = 0;
