...
export = class Map_CTL_RT_X1_1 extends Map_CTL_RT_X1_Ts {
    constructor() {
        super();
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态",'',Map_CTL_RT_X1_1.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间","时"));
        this.addPoint(new CountShowField(Map_CTL_RT_X1_1.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(Map_CTL_RT_X1_1.KEY_BASE,SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        ...
        this.addPoint(new DeviceField("de_bushuibeng_shoudong/zidong_", 49, 2, "补水泵",1, Map_CTL_RT_X1_1.coms_auto));
        this.addPoint(new DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "热水泵",3, Map_CTL_RT_X1_1.coms_auto));
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG, 9, 2, "热水泵控制",2,Map_ZH_CN.coms_open_close));
