...
export class Map_CTL_RT_X1_HNRT_DRS_4 extends Map_CTL_RT_X1_3JDJD {
    constructor() {
        ...
        this.addPoint(new FixedValueField(SdcSoftDevice.KEY_POINT_POWER, "燃料类型", 1, Map_CTL_RT_X1_HNRT_DRS_4.coms_power))

        this.addPoint(new DeviceField("oc_jiarezu1kongzhi", 9, 2, "加热组1", 0, Map_CTL_RT_X1_HNRT_DRS_4.coms_open_close))
        this.addPoint(new DeviceField("oc_jiarezu2kongzhi", 9, 2, "加热组2", 1, Map_CTL_RT_X1_HNRT_DRS_4.coms_open_close))
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "热水泵", 2, Map_CTL_RT_X1_HNRT_DRS_4.coms_open_close))
