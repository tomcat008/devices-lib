...
export class Map_CTL_RT_X1_HNRT_RYRS_8 extends Map_CTL_RT_X1_ReShui {
    constructor() {
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_RAN_SHAO_QI_KONGZHI, 9, 2, '燃烧器', 0, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))

        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_Add_SHUI_BENG_1, 9, 2, '补水泵', 1, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new DeviceField('de_bushuibeng_shoudong/zidong_', 49, 2, '补水泵 手/自', 1, Map_CTL_RT_X1_HNRT_RYRS_8.coms_auto))
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, '出水泵', 2, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        ...
        this.addPoint(new OpenCloseField('oc_didianji', 5, 2, '低位电极', 1, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new OpenCloseField('oc_gaodianji', 5, 2, '高位电极', 2, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new OpenCloseField('oc_lubiwendukaiguan', 5, 2, '炉壁温度开关', 4, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new OpenCloseField('oc_shuixiangdiweidianji', 5, 2, '水箱低位电极', 5, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new OpenCloseField('oc_shuixianggaoweidianji', 5, 2, '水箱高位电极', 6, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
        this.addPoint(new OpenCloseField('oc_ranshaoqiguzhang', 5, 2, '燃烧器故障', 7, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))

        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_Add_SHUI_BENG_1, 9, 2, '补水泵控制', 1, Map_CTL_RT_X1_HNRT_RYRS_8.coms_open_close))
