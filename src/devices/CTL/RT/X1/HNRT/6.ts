...
export = class CTL_RT_X1_HNRT_6 extends CTL_RT_X1_ZhengQi {

    protected getPowerInfo() {
        let map = this.getOpenCloseFields();
        if (map.getItem(CTL_RT_X1_HNRT_6.KEY_POINT_RAN_SHAO_QI_KONGZHI).getValue() > 0) {
    ...
    protected addFocusFields(list: List<DeviceFieldForUI>) {
        ...
        field.setValue(a | b, Map_CTL_RT_X1_ZhengQi.KZQ_YaLiStatus);
