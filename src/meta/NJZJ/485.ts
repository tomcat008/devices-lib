...
export class SystemStatusField extends BaseInfoField {
    constructor(name: string, startIndex: number, bytesLength: number, title: string,
        valueMap: { [key: number]: string },
        cmdGroupKey: string, address: string, minValue: number, maxValue: number) {
        super(name, startIndex, bytesLength, title, '')
