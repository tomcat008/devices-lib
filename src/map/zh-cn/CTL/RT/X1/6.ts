...
export = class CTL_RT_X1_RYZQFHTJ extends CTL_RT_X1_Ts {
    constructor() {
        super();
        ...
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态", '', CTL_RT_X1_RYZQFHTJ.coms_status));
        this.addPoint(new BaseInfoField(SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间", "时"));
        this.addPoint(new CountShowField(CTL_RT_X1_RYZQFHTJ.KEY_BASE, SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        this.addPoint(new CountShowField(CTL_RT_X1_RYZQFHTJ.KEY_BASE, SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        this.addPoint(new CountShowField(CTL_RT_X1_RYZQFHTJ.KEY_BASE, 'ba_yalizhuangtai', "压力状态", ''));
        ...
        this.addPoint(new DeviceField("de_bushuibeng_shoudong/zidong_", 49, 2, "给水泵", 1, CTL_RT_X1_RYZQFHTJ.coms_auto));
        ...
        this.addPoint(new OpenCloseField("oc_fuhetiaojie", 5, 2, "负荷调节", 4, ZH_CN.coms_open_close));
        this.addPoint(new OpenCloseField("oc_qitingkongzhi", 5, 2, "启停控制", 5, ZH_CN.coms_open_close));
