...
export class Map_CTL_RT_X1_BKSR_RMZQ_9 extends Map_CTL_RT_X1_ZhengQi {
    constructor() {
        ...
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_YIN_FENG_FAN_1, 9, 2, "引风机", 0, Map_CTL_RT_X1_BKSR_RMZQ_9.coms_open_close))
        this.addPoint(new DeviceField(CTL_RT.KEY_POINT_GU_FENG_FAN_1, 9, 2, "鼓风机", 1, Map_CTL_RT_X1_BKSR_RMZQ_9.coms_open_close))
        ...
        this.addPoint(new OpenCloseField("oc_dianjiedianyalibiaodizhen", 5, 2, "电接点压力低针", 4, Map_CTL_RT_X1_BKSR_RMZQ_9.coms_open_close))
        this.addPoint(new OpenCloseField("oc_dianjiedianyalibiaogaozhen", 5, 2, "电接点压力高针", 5, Map_CTL_RT_X1_BKSR_RMZQ_9.coms_open_close))
        this.addPoint(new OpenCloseField("oc_chaoyabaojing", 5, 2, "超压报警", 6, Map_CTL_RT_X1_BKSR_RMZQ_9.coms_open_close))
